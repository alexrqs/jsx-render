...
test('Conditional Component', t => {
  function render() {
    return renderClient(<div>{true && 2}</div>)
  }
  function notRender() {
    return renderClient(<div>{false && 2}</div>)
  }
...
test('Component with Data Attributes', t => {
  function renderDataAttrs() {
    return renderClient(<div data-merci="merci beaucoup" />)
  }
...
test('Component with Attributes', t => {
  function renderAttrs() {
    return renderClient(<img src="img_.jpg" width="500" height="600" />)
  }
...
test('Components with classname p.chan', t => {
  function render() {
    return renderClient(<p className="chan">Lorem</p>)
  }
...
test('Component render dangerouslySetInnerHTML', t => {
  function render() {
    return renderClient(<div dangerouslySetInnerHTML={{ __html: '<span>StrangerDanger</span>' }} />)
  }
...
test('Class Complex Component render', t => {
  ...
  function render() {
    return renderClient(<Foo width="10px" height="20px" />)
  }
